...
function telaDerrota(){
    document.getElementById('resultado').innerHTML = '<img src="perdeu.png">'
}

function telaVitoria(){
    document.getElementById('resultado').innerHTML = '<img src="ganho.jpg">'
}
...
/*
    Sistema de vida [V]
    Lista de letras erradas [V]
    Sistema de derrota [V]
    Sistema de vitória [V]
    Palavras com espaço/hífen [V]
    Permitir somente letras [V]
    Sistema temporizador [V]
*/